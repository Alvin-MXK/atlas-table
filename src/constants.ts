...
export enum FeatureList {
  ...
  search_and_filter_within_columns = "search_and_filter_within_columns",
  bulk_selection_and_editing = "bulk_selection_and_editing",
  customize_style = "customize_style",
  arranging_and_customizing_columns = "arranging_and_customizing_columns",
  adjust_column_width = "adjust_column_width",
  download = "download",
  global_search = "global_search",
  column_pinning = "column_pinning",
  group = "group",
  show_detail_information_by_sideView = "show_detail_information_by_sideView",
  switch_view_mode = "switch_view_mode",
  support_keyboard_control = "support_keyboard_control",
  hover_highlight = "hover_highlight",
  customize_group = "customize_group",
  inline_editing = "inline_editing",
}

export const featureList = {
  pagination: "Pagination(Basic)",
  column_sorting: "Column Sorting(Basic)",
  search_and_filter_within_columns: "Search and filter within columns(Basic)",
  bulk_selection_and_editing: "Bulk selection and editing(Basic)",
  customize_style: "Customize style(Basic)",
  arranging_and_customizing_columns:
    "Arranging and Customizing columns(Advanced)",
  adjust_column_width: "Adjust Column Width(Advanced)",
  download: "Download(Advanced)",
  global_search: "Global Search(Nice to Have)",
  column_pinning: "Column Pinning(Advanced)",
  group: "Group(Advanced)",
  show_detail_information_by_sideView:
    "Show detail information by SideView(Advanced)",
  switch_view_mode:
    "Switch view mode: Compact view / Default view(Nice to Have)",
  support_keyboard_control: "Support keyboard control(Nice to Have)",
  hover_highlight: "Hover highlight on table row(Nice to Have)",
  customize_group: "Customize Group(Advanced)",
  inline_editing: "Inline Editing(Advanced)",
};
